...
image = cv2.imread("curling_blur3_daube.jpg")
# image = cv2.resize(image, (2000,2000))

# change contrast and brightness
contrast_brightness = apply_brightness_contrast(image, -106, 122)
...
circles = cv2.HoughCircles(gray, cv2.HOUGH_GRADIENT, 1.2, 100, param1=10, param2=20)
